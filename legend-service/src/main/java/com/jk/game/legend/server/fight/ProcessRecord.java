...
public class ProcessRecord {
    ...
    public static void record(Respond respond, UserInfo p1, UserInfo p2){
        //记录p1与p2玩家的基础伤害
        double basicDamagep1 = p1.getAttack() * (double) p2.getDefensive() / (p2.getDefensive() + 5);
        double basicDamagep2 = p2.getAttack() * (double) p1.getDefensive() / (p1.getDefensive() + 5);
        double critHarm = 0;
        double attackTwice = 0;
        //是否触发暴击
